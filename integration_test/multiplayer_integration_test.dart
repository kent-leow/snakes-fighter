...
void main() {
  ...
  group('Multiplayer Game Flow Integration Tests', () {
    testWidgets('Complete app startup and initialization flow', (
      WidgetTester tester,
    ) async {
      // Start the app
      app.main();
    ...
    testWidgets('App handles Firebase initialization', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('Navigation and routing works correctly', (
      WidgetTester tester,
    ) async {
      app.main();
    ...
    group('Performance Tests', () {
      testWidgets('App startup performance is acceptable', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Memory usage is reasonable during app lifecycle', (
        WidgetTester tester,
      ) async {
    ...
    group('Error Handling Tests', () {
      testWidgets('App handles initialization errors gracefully', (
        WidgetTester tester,
      ) async {
        app.main();
        await tester.pumpAndSettle();
  ...
  group('Game Engine Integration Tests', () {
    testWidgets('App services initialization works correctly', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Provider scope handles state management', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle();
  ...
  group('UI Integration Tests', () {
    ...
    testWidgets('Authentication wrapper loads properly', (
      WidgetTester tester,
    ) async {
      app.main();
      await tester.pumpAndSettle();
