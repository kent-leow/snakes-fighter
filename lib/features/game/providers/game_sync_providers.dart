...
final gameEventStreamProvider = StreamProvider.family<GameEvent, String>((
  ref,
  roomId,
) {
...
final playerMoveEventStreamProvider =
    StreamProvider.family<PlayerMoveEvent, String>((ref, roomId) {
      final broadcaster = ref.watch(gameEventBroadcasterProvider);
...
final foodConsumedEventStreamProvider =
    StreamProvider.family<FoodConsumedEvent, String>((ref, roomId) {
      final broadcaster = ref.watch(gameEventBroadcasterProvider);
...
final playerDeathEventStreamProvider =
    StreamProvider.family<PlayerDeathEvent, String>((ref, roomId) {
      final broadcaster = ref.watch(gameEventBroadcasterProvider);
...
final gameStartEventStreamProvider =
    StreamProvider.family<GameStartEvent, String>((ref, roomId) {
      final broadcaster = ref.watch(gameEventBroadcasterProvider);
...
final gameEndEventStreamProvider = StreamProvider.family<GameEndEvent, String>((
  ref,
  roomId,
) {
  final broadcaster = ref.watch(gameEventBroadcasterProvider);
