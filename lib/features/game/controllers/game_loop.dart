...
class GameLoop {
  ...
  GameLoop({required void Function(Duration elapsed) onTick}) : _onTick = onTick;
  ...
  void _trackFramePerformance(DateTime frameStart) {
    ...
    if (frameTime > _targetFrameTime * 2) {
      debugPrint('Frame took ${frameTime.inMilliseconds}ms (target: ${_targetFrameTime.inMilliseconds}ms)');
    }
  }
