...
class GameFlowManager {
  ...
  Future<void> prepareGame(String roomId, Map<String, Player> players) async {
    ...
    _eventController.add(GameFlowEvent.gameReady(
      roomId: roomId,
  ...
  Future<void> startGame() async {
    ...
    try {
      ...
      _eventController.add(GameFlowEvent.gameStarted(
        roomId: _currentRoomId!,
        players: _currentPlayers,
      ));
      
    } catch (e) {
      _eventController.add(GameFlowEvent.error(
  ...
  Future<void> pauseGame() async {
    ...
    _eventController.add(GameFlowEvent.gamePaused(
      roomId: _currentRoomId!,
    ));
  }
  ...
  Future<void> resumeGame() async {
    ...
    _eventController.add(GameFlowEvent.gameResumed(
      roomId: _currentRoomId!,
    ));
  }
  ...
  Future<void> endGame({String? reason}) async {
    ...
    _eventController.add(GameFlowEvent.gameEnded(
      roomId: _currentRoomId!,
  ...
  Future<void> _gameLoopTick(Timer timer) async {
    ...
    try {
      ...
      _eventController.add(GameFlowEvent.gameUpdate(
        roomId: _currentRoomId!,
        updateResult: result,
      ));
  ...
  void _transitionToState(GameFlowState newState) {
    ...
    _eventController.add(GameFlowEvent.stateChanged(
      fromState: oldState,
      toState: newState,
      roomId: _currentRoomId,
    ));
...
abstract class GameFlowEvent {
  ...
  /// Game was paused.
  factory GameFlowEvent.gamePaused({
    required String roomId,
  }) = _GamePausedEvent;
  
  /// Game was resumed.
  factory GameFlowEvent.gameResumed({
    required String roomId,
  }) = _GameResumedEvent;
...
class _GameReadyEvent extends GameFlowEvent {
  ...
  @override
  String toString() => 'GameReadyEvent(roomId: $roomId, players: ${players.length})';
}
...
class _GameStartedEvent extends GameFlowEvent {
  ...
  @override
  String toString() => 'GameStartedEvent(roomId: $roomId, players: ${players.length})';
}
...
class _GameUpdateEvent extends GameFlowEvent {
  ...
  @override
  String toString() => 'GameUpdateEvent(roomId: $roomId, gameEnded: ${updateResult.gameEnded})';
}
...
class _GameEndedEvent extends GameFlowEvent {
  ...
  @override
  String toString() => 'GameEndedEvent(roomId: $roomId, reason: $reason, winner: $winner)';
}
...
class _StateChangedEvent extends GameFlowEvent {
  ...
  @override
  String toString() => 'StateChangedEvent(from: $fromState, to: $toState, roomId: $roomId)';
}
